...
function phepcong(){
    ...
    document.getElementById("bd221").style.color = "#da1a32";
    document.getElementById("bd222").style.color = "#1e1e1e";
    document.getElementById("bd223").style.color = "#1e1e1e";
    document.getElementById("bd224").style.color = "#1e1e1e";
}
function pheptru(){
    var x=document.getElementById("n4").value;
    var y=document.getElementById("n5").value;
    ...
    document.getElementById("bd222").style.color = "#da1a32";
    document.getElementById("bd221").style.color = "#1e1e1e";
    document.getElementById("bd223").style.color = "#1e1e1e";
    document.getElementById("bd224").style.color = "#1e1e1e";
...
function phepnhan(){
    ...
    document.getElementById("bd223").style.color = "#da1a32";
    document.getElementById("bd221").style.color = "#1e1e1e";
    document.getElementById("bd222").style.color = "#1e1e1e";
    document.getElementById("bd227").style.color = "#1e1e1e";
...
function phepchia(){
    ...
    document.getElementById("bd224").style.color = "#da1a32";
    document.getElementById("bd221").style.color = "#1e1e1e";
    document.getElementById("bd222").style.color = "#1e1e1e";
    document.getElementById("bd223").style.color = "#1e1e1e";
